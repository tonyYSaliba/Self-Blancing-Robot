...
public class MainActivity extends Activity {
    ...
    PrintStream PS;
    String command;
    private static  int SERVERPORT = 80;                    // Change the server port from here (It's better not to change it)
    private static  String SERVER_IP = "172.20.10.2";       // write the ESP ip address over here.
    boolean start =true;
